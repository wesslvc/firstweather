...
export const LOCATIONS: Array<{
  ...
  { name: '서울', sub: '중구',   region: '대한민국', nx: 60,  ny: 127, station: '중구'   },
  ...
  { name: '경기', sub: '김포',   region: '대한민국', nx: 55,  ny: 128, station: '김포'   },
  { name: '강원', sub: '원주',   region: '대한민국', nx: 76,  ny: 122, station: '원주'   },
  { name: '충북', sub: '청주',   region: '대한민국', nx: 69,  ny: 107, station: '영운동' },
  { name: '충남', sub: '천안',   region: '대한민국', nx: 63,  ny: 110, station: '천안'   },
  { name: '전북', sub: '전주',   region: '대한민국', nx: 63,  ny: 89,  station: '전주'   },
  { name: '전남', sub: '여수',   region: '대한민국', nx: 73,  ny: 66,  station: '여수'   },
  { name: '경북', sub: '포항',   region: '대한민국', nx: 102, ny: 94,  station: '포항'   },
  { name: '경남', sub: '창원',   region: '대한민국', nx: 90,  ny: 77,  station: '창원'   },
